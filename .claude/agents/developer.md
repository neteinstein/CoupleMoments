---
name: developer
description: Implements features, bug fixes, and refactors in the Couple Moments Android codebase, following its Gradle multi-module boundaries, MVVM conventions, and Koin DI wiring. Use proactively for any code implementation task - new screens, use cases, repository changes, or bug fixes.
