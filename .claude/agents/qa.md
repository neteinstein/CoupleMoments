---
name: qa
description: Writes and runs unit tests (JUnit4, MockK, kotlinx-coroutines-test) for any relevant part of the Family Moments codebase - ViewModels, use cases, repositories, mappers, DAOs/migrations - verifies coverage targets, and always adds a regression test for every bug fixed. Use proactively after any implementation change, or when asked to add/fix tests, check coverage, or verify a bug fix.
