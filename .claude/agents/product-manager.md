...
description: Reviews implemented features and UI changes in the Family Moments app from a product/usability perspective - discoverability, interaction consistency, copy clarity, accessibility, and empty/edge states. Delegates fixes to developer and edge-case test coverage to qa. Use proactively after a feature is implemented, or when asked to review usability/UX.
