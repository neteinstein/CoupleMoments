...
description: 'Reviews changes for OWASP Mobile-class vulnerabilities, secret handling, dependency risk, and GitHub Actions workflow permission exposure in the Couple Moments codebase; delegates fixes to Developer and verification to QA.'
