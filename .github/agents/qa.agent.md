---
name: 'QA'
description: 'Writes and runs JUnit4/MockK unit tests for any relevant part of the Family Moments codebase - ViewModels, use cases, repositories, mappers, DAOs/migrations - verifies coverage targets, and always adds a regression test for every bug fixed.'
