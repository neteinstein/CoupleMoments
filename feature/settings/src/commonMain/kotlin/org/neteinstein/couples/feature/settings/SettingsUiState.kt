...
data class SettingsUiState(
    ...
    /**
     * The user's in-app language override, or `null` to follow the OS/browser language. Only ever
     * set on iOS/Web, which have no OS-level per-app language settings page to deep-link into -
