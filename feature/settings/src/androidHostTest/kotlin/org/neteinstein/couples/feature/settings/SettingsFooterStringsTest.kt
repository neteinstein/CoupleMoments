...
class SettingsFooterStringsTest {
    private val resDir =
        // The strings moved from Android resources to Compose Multiplatform ones when this module
        // converted to KMP; both spellings are tried because the working directory differs between
        // running this module's tests directly and running them from the repo root.
