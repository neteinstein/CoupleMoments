...
compose.resources {
    packageOfResClass = "org.neteinstein.couples.feature.settings.resources"
}

kotlin {
    android {
        namespace = "org.neteinstein.couples.feature.settings"
    }
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            // SettingsPlatformActions.android.kt: LocalContext-driven Intent launch into the OS
            // per-app language screen, and the PackageManager version-name lookup.
