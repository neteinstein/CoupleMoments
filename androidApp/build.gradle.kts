...
android {
    namespace = "org.neteinstein.couples"
    compileSdk = 37

    defaultConfig {
        applicationId = "org.neteinstein.couples"
        minSdk = 32
        targetSdk = 37
    ...
    // androidApp/src/github/AndroidManifest.xml for its extra permission/provider/receiver); "playstore"
...
dependencies {
    // Provides the shared App()/MainViewModel/navigation/DI - MainActivity/CoupleMomentsApp call
    // straight into it. androidApp's own code has no direct dependency on any core:*/feature:*
    // module any more; everything it needs reaches it transitively through `app`.
