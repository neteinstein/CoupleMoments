...
/**
 * Downloads the APK bytes for a previously-found [AppUpdate], ready to be handed to
...
class DownloadAppUpdateUseCase(
    ...
    suspend operator fun invoke(update: AppUpdate): Result<ByteArray> = updateRepository.downloadUpdate(update)
}
